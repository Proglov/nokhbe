...
export const workingGroups = [
    ...
    [
        {
            name: 'سرکار خانم مهناز نقی زاده',
            position: 'کارگروه خانواده درمانی و زوج درمانی'
        },
        {
            name: 'سرکار خانم منصوره شریفی',
            position: 'کارگروه اختلالات و مهارت های فردی'
        },
        {
            name: 'سرکار خانم عطیه مشائی',
            position: 'کارگروه تحصیلی، شغلی و فرزندپروری'
        },
    ],
]
